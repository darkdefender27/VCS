...
public class FileUpload {
   ...
   public String executeMultiPartRequest(String urlString, File file, String fileName, String fileDescription) {
       ...
       try{
           ...
           /*Need to construct a FileBody with the file that needs to be attached and specify the mime type of the file. 
            * Add the fileBody to the request as an another part.
